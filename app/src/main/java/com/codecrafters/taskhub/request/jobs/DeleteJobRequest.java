...
public class DeleteJobRequest extends AsyncTask<String, Void, Boolean> {

    @Override
    protected Boolean doInBackground(String... strings) {
        try {
            URL delete = new URL("http://" + ConnectionFactory.SERVER_IP + ":8080/trabalhos/" + strings[0] + "/deletar");
